...
public class Car_Wiring extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_car_wiring);
        ...
        final ImageView isinya = findViewById(R.id.isinya);
        final ImageView bisil = findViewById(R.id.bisil);
        ...
        bisil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), Bisil.class);
                startActivity(i);
            }
        });
    }
